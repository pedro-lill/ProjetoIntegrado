...
insert into inseminacao (codInseminacao, codAnimal, dtInseminacao, dtPrevisaoParto, touroInseminador, inseminadorResponsavel, retorno, obs) values
  (NULL, 101,'2021-05-04', '2021-12-04','benz','Gilmar', 'Não', 'ok'),
  (NULL, 102,'2021-10-04', '2021-12-04','polita','Felipe', 'Não', 'ok'),
  (NULL, 101,'2021-05-04', '2021-12-04','benz','Gilmar', 'Não', 'ok'),
  (NULL, 102,'2021-10-04', '2021-12-04','polita','Felipe', 'Não', 'ok'),
  (NULL, 101,'2021-05-04', '2021-12-04','benz','Gilmar', 'Não', 'ok'),
  (NULL, 102,'2021-10-04', '2021-12-04','polita','Felipe', 'Não', 'ok'),
  (NULL, 101,'2021-05-04', '2021-12-04','benz','Gilmar', 'Não', 'ok'),
  (NULL, 102,'2021-10-04', '2021-12-04','polita','Felipe', 'Não', 'ok'),
  (NULL, 104,'2021-12-04', '2021-12-04','polita','Felipe', 'Não', 'ok'),
  (NULL, 144,'2021-05-04', '2021-12-04','benz','Gilmar', 'Não', 'ok'),
  (NULL, 1,  '2020-03-29', '2020-12-29', 'sekita troler', 'gilmar', 'Não', 'ok'),
  (NULL, 8,  '2020-03-06', '2020-12-06', 'sekita troler', 'gilmar', 'sim', 'ok'),	
  (NULL, 13, '2020-03-02', '2020-12-02', 'sekita troler', 'gilmar', 'Não', 'ok'),
  (NULL, 20, '2020-03-05', '2020-12-05', 'seleno', 'gilmar', 'Não', 'ok'),
  (NULL, 27, '2020-03-26', '2020-12-26', 'sekita troler', 'gilmar'	, 'Não', 'ok'),
  (NULL, 101,'2020-03-26', '2020-12-26', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 196,'2020-03-11', '2020-12-11', 'lockdon', 'gilmar', 'Não', 'ok'),
  (NULL, 218,'2020-03-16', '2020-12-16', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 226,'2020-03-18', '2020-12-18', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 240,'2020-03-04', '2020-12-04', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 243,'2020-03-11', '2020-12-11', 'lockdon', 'gilmar', 'Não', 'ok'),
  (NULL, 246,'2020-03-12', '2020-12-12', 'sembra', 'gilmar', 'Não', 'ok'),
  (NULL, 291,'2020-03-16', '2020-12-16', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 319,'2020-03-04', '2020-12-04', 'masas','gilmar', 'Não', 'ok'),
  (NULL, 852,'2020-03-25', '2020-12-25', 'sekita troler', 'gilmar', 'Não', 'ok'),	
  (NULL, 853,'2020-03-06', '2020-12-06', 'sekita troler', 'gilmar', 'Não', 'ok'),
  (NULL, 861,'2020-03-06', '2020-12-06', 'sekita troler', 'gilmar', 'Não', 'ok');
